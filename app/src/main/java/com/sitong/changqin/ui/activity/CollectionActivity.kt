...
import com.sitong.changqin.ui.adapter.CollectionListAdapter
...
// 创建菜单：
        ...
        mPresenter?.getMusicList("2")
        LogUtils.e("测试路径"+filesDir)
        LogUtils.e("测试路径"+getExternalFilesDir(null))
        LogUtils.e("测试路径"+getExternalFilesDir("DownLoads"))
        FilesUtils.getFilesAllName(getExternalFilesDir("DownLoads").absolutePath)?.forEach {
            LogUtils.e("测试路径：文件--"+it)
        }
    }
