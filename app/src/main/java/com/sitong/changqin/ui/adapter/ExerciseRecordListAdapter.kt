 ...
 */
class ExerciseRecordListAdapter(var context: Context) : RecyclerView.Adapter<ExerciseRecordListAdapter.ViewHolder>() {
...
//        holder.viewLayout.tv_name_content.text = ""+list[position].
