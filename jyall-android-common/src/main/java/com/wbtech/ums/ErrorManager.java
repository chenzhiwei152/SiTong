...
//    public static final String ERROR_URL = "/ums/error.php";
    ...
    private JSONObject prepareErrorJSON(String errorinfo,Context context) {
    ...
    public void postErrorInfo(String error ,Context context) {
        JSONObject errorJSON;
        try {
            errorJSON = prepareErrorJSON(error , context);
        } catch (Exception e) {
            CobubLog.e(tag, e);
            return;
        }
