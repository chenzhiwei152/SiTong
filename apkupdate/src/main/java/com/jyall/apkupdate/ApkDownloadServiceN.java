...
public class ApkDownloadServiceN extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        sharedPreferences = getSharedPreferences("apkUpdate", MODE_PRIVATE);
                    ...
                    if(fileapk==null){
                        ...
                        if(fileapk.exists()){
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                                ...
                                Uri contentUri = FileProvider.getUriForFile(context, getAppId(context) + ".fileprovider", new File(filePath + "/" + fileName));
