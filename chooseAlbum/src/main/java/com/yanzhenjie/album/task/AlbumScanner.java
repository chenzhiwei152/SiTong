...
public class AlbumScanner {
     ...
     */
    public List<AlbumFolder> getPhotoAlbum(Context context, List<AlbumImage> hasChoose) {
        ...
        while (cursor.moveToNext()) {
            ...
            int hasChooseSize = hasChoose == null ? 0 : hasChoose.size();
            for (int i = 0; i < hasChooseSize; i++) {
                if (hasChoose.contains(albumImage)) {
